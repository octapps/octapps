...
## -*- texinfo -*-
## @deftypefn  {} {} octforge_chi2rnd (@var{n})
## @deftypefnx {} {} octforge_chi2rnd (@var{n}, @var{r})
## @deftypefnx {} {} octforge_chi2rnd (@var{n}, @var{r}, @var{c}, @dots{})
## @deftypefnx {} {} octforge_chi2rnd (@var{n}, [@var{sz}])
...
function rnd = octforge_chi2rnd (n, varargin)
...
%!error octforge_chi2rnd ()
%!error octforge_chi2rnd (ones (3), ones (2))
%!error octforge_chi2rnd (ones (2), ones (3))
%!error octforge_chi2rnd (i)
%!error octforge_chi2rnd (1, -1)
%!error octforge_chi2rnd (1, ones (2))
%!error octforge_chi2rnd (1, [2 -1 2])
%!error octforge_chi2rnd (ones (2,2), 3)
%!error octforge_chi2rnd (ones (2,2), [3, 2])
%!error octforge_chi2rnd (ones (2,2), 2, 3)
