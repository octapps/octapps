...
## -*- texinfo -*-
## @deftypefn {} {} octforge_stdnormal_inv (@var{x})
...
function inv = octforge_stdnormal_inv (x)
...
%!shared x
%! x = [-1 0 0.5 1 2];
%!assert (octforge_stdnormal_inv (x), [NaN -Inf 0 Inf NaN])
...
%!error octforge_stdnormal_inv ()
%!error octforge_stdnormal_inv (1,2)
%!error octforge_stdnormal_inv (i)
