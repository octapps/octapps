...
## -*- texinfo -*-
## @deftypefn  {} {} octforge_normrnd (@var{mu}, @var{sigma})
## @deftypefnx {} {} octforge_normrnd (@var{mu}, @var{sigma}, @var{r})
## @deftypefnx {} {} octforge_normrnd (@var{mu}, @var{sigma}, @var{r}, @var{c}, @dots{})
## @deftypefnx {} {} octforge_normrnd (@var{mu}, @var{sigma}, [@var{sz}])
...
function rnd = octforge_normrnd (mu, sigma, varargin)
...
%!error octforge_normrnd ()
%!error octforge_normrnd (1)
%!error octforge_normrnd (ones (3), ones (2))
%!error octforge_normrnd (ones (2), ones (3))
%!error octforge_normrnd (i, 2)
%!error octforge_normrnd (2, i)
%!error octforge_normrnd (1,2, -1)
%!error octforge_normrnd (1,2, ones (2))
%!error octforge_normrnd (1, 2, [2 -1 2])
%!error octforge_normrnd (1,2, 1, ones (2))
%!error octforge_normrnd (1,2, 1, -1)
%!error octforge_normrnd (ones (2,2), 2, 3)
%!error octforge_normrnd (ones (2,2), 2, [3, 2])
%!error octforge_normrnd (ones (2,2), 2, 2, 3)
