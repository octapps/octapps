...
## -*- texinfo -*-
## @deftypefn  {} {} octforge_gamrnd (@var{a}, @var{b})
## @deftypefnx {} {} octforge_gamrnd (@var{a}, @var{b}, @var{r})
## @deftypefnx {} {} octforge_gamrnd (@var{a}, @var{b}, @var{r}, @var{c}, @dots{})
## @deftypefnx {} {} octforge_gamrnd (@var{a}, @var{b}, [@var{sz}])
...
function rnd = octforge_gamrnd (a, b, varargin)
...
%!error octforge_gamrnd ()
%!error octforge_gamrnd (1)
%!error octforge_gamrnd (ones (3), ones (2))
%!error octforge_gamrnd (ones (2), ones (3))
%!error octforge_gamrnd (i, 2)
%!error octforge_gamrnd (2, i)
%!error octforge_gamrnd (1,2, -1)
%!error octforge_gamrnd (1,2, ones (2))
%!error octforge_gamrnd (1, 2, [2 -1 2])
%!error octforge_gamrnd (1,2, 1, ones (2))
%!error octforge_gamrnd (1,2, 1, -1)
%!error octforge_gamrnd (ones (2,2), 2, 3)
%!error octforge_gamrnd (ones (2,2), 2, [3, 2])
%!error octforge_gamrnd (ones (2,2), 2, 2, 3)
