...
function results = DoFstatInjections(varargin)
  ...
  parseOptions(varargin,
               ...
               {"inj_orbitasini", "real,scalar", octforge_unifrnd(1.0,3.0)},
               {"inj_orbitEcc", "real,scalar", octforge_unifrnd(0.0,1.0)},
               {"inj_orbitTpSSB", "real,strictpos,scalar", octforge_unifrnd(6e8,6.5e8)},
               {"inj_orbitPeriod", "real,scalar", octforge_unifrnd(3600.0,86400.0)},
               {"inj_orbitArgp", "real,scalar", octforge_unifrnd(0.0,2*pi)},
               ...
               {"randSeed", "integer,strictpos,scalar", floor(octforge_unifrnd(1, 2^32 - 1))},
               []);
