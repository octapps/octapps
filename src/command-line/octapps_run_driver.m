...
%!test
%!  status = system("octapps_run __test_parseOptions --help");
%!  assert(status == 1);
%!test
%!  [status, output] = system("octapps_run __test_parseOptions --real-strictpos-scalar 1.23 --integer-vector='[3,9,5]' --string 'Hi there' --cell '{1,{2,3}}'");
%!  assert(status == 0);
